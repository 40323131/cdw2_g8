...
@ag8_40323137_3.route('/scrum1_demo1')
def demo1():
    outstring = '''
<!DOCTYPE html>
<html>
...
@ag8_40323137_3.route('/scrum1_demo2')
def demo2():
    outstring = '''
<!DOCTYPE html>
<html>
...
@ag8_40323137_3.route('/scrum1_demo3')
def demo3():
    outstring = '''
<!DOCTYPE html>
<html>
...
##############                      Week 8 範例          ###############
##########################################################
@ag8_40323137_3.route('/scrum1_week8_main')
def week8_main():
    outstring = '''
<!DOCTYPE html>
<html>
...
@ag8_40323137_3.route('/scrum1_week8_tail')
def week8_tail():
    return "</body></html>"

# 畫 a 函式
@ag8_40323137_3.route('/scrum1_week8_a')
def week8_a():
    outstring = '''
from javascript import JSConstructor
...
# 畫 b 函式
@ag8_40323137_3.route('/scrum1_week8_b')
def week8_b():
    outstring = '''
from javascript import JSConstructor
from browser import alert
...
# 畫 C 函式
@ag8_40323137_3.route('/scrum1_week8_c')
def week8_c():
    outstring = '''
from javascript import JSConstructor
from browser import alert
...
# 畫 D 函式
@ag8_40323137_3.route('/scrum1_week8_d')
def week8_d():
    outstring = '''
from javascript import JSConstructor
from browser import alert
...
# 在內部函式傳回字串的層次呼叫測試
@ag8_40323137_3.route('/scrum1_week8_test')
def week8_test():
    outstring = week8_main() + week8_a() + week8_tail()
    return outstring

# 在 URL傳回字串的層次呼叫測試
@ag8_40323137_3.route('/scrum1_week8_abcd')
def week8_abcd():
...
# 在 URL傳回字串的層次呼叫測試
@ag8_40323137_3.route('/scrum1_week8_abc')
def week8_abc():
    outstring = week8_main()
    outstring += "<script type='text/python' src='/ag100/scrum1_week8_a'></script>"
    outstring += "<script type='text/python' src='/ag100/scrum1_week8_b'></script>"
